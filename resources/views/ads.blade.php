        ...
        <div class="content">
            ...
            <table class="table table-bordered">
                ...
                @foreach($data as $datas)
                    <tr>
                        @if($datas->previlege==0 &&$datas->category=='ads')   
                                <td>{{ $no++ }}</td>
                                ...
                                <td>
                                        ...
                                        <a href="{{ url('/hapusfile', $datas->uid) }}" class="btn btn-sm btn-danger" type="submit" onclick="return confirm('Yakin ingin menghapus data?')">Hapus</a>
