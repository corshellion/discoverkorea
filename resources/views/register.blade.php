...
@section('content')
    ...
    <section class="main-section">
        ...
        <div class="content">
            ...
            <h1>Discover Korea -  Register Admin</h1>
            <hr>
            @if ($errors->any())
            ...
            <form action="{{ url('/registerPost') }}" method="post">
                ...
                <div class="form-group">
                    <label for="alamat">Nama Default:</label>
                    <input type="text"  class="form-control" id="name" name="name" value="Discover Korea" readonly>
                </div>
                <div class="form-group">
                    <label for="username">Username:</label>
                    <input type="username" class="form-control" id="username" name="username" placeholder="Username Administrator">
                </div>
                <div class="form-group">
                    <label for="email">E-mail:</label>
                    <input type="email" class="form-control" id="email" name="email" placeholder="E-mail baru Administrator">
                </div>
                <div class="form-group">
                    <label for="alamat">Kata Sandi:</label>
                    <input type="password" class="form-control" id="password" name="password" placeholder="Kata Sandi">
                </div>
                <div class="form-group">
                    <label for="alamat">Konfirmasi Kata Sandi:</label>
                    <input type="password" class="form-control" id="confirmation" name="confirmation" placeholder="Konfirmasi Kata Sandi">
                </div>
